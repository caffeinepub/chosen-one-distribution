...
export interface backendInterface {
    ...
    addTrack(track: Track, audioFormat?: string | null): Promise<void>;
...
import type { StripeSessionStatus as _StripeSessionStatus, Time as _Time, Track as _Track, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTrack(arg0: Track, arg1?: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrack(to_candid_Track_n8(this._uploadFile, this._downloadFile, arg0), arg1 ? [arg1] : []);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyUploadedTracks(): Promise<Array<Track>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyUploadedTracks();
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrackAudioFileBlobId(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrackAudioFileBlobId(arg0);
    ...
    async getTrackAudioFormat(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrackAudioFormat(arg0);
                return from_candid_opt_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrackCoverArtBlobId(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrackCoverArtBlobId(arg0);
                return from_candid_opt_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasPurchasedTrack(arg0: string, arg1: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPurchasedTrack(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTrack(arg0: Track): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTrack(to_candid_Track_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyPaymentAndRecordPurchase(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyPaymentAndRecordPurchase(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Track_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Track): Track {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Track]): Track | null {
    return value.length === 0 ? null : from_candid_Track_n13(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        audioFileBlobId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.audioFileBlobId)),
        coverArtBlobId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.coverArtBlobId)),
        title: value.title,
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Track>): Array<Track> {
    return value.map((x)=>from_candid_Track_n13(_uploadFile, _downloadFile, x));
}
function to_candid_Track_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Track): _Track {
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        audioFileBlobId: value.audioFileBlobId ? candid_some(value.audioFileBlobId) : candid_none(),
        coverArtBlobId: value.coverArtBlobId ? candid_some(value.coverArtBlobId) : candid_none(),
        title: value.title,
        description: value.description,
        genre: value.genre,
        artist: value.artist,
